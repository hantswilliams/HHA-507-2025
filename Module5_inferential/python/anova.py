...
# Read in the data
df = pd.read_csv('Module5_inferential/data/nys-opioid-visits/All_Payer_Opioid-Related_Facility_Visits_in_New_York_State__Beginning_2010__SPARCS_.csv') # noqa
...
## save as temp file
df2.to_csv('Module5_inferential/data/nys-opioid-visits/sparcs_opioid_clean.csv', index=False) # noqa
