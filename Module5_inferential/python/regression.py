...
# load in dataset
df = pd.read_csv('Module5_inferential/data/cms-hospital-provider-costs/Hospital_Cost_Report_2019.csv')
...
## save 
df.to_csv('Module5_inferential/data/cms-hospital-provider-costs/Hospital_Cost_Report_2019_small.csv')
